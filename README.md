...
| OS | 파일 | 설치 |
|----|------|------|
| **Windows** | `BirdPocket-1.1.3.exe` | 더블클릭 (설치 불필요한 포터블). 경고 시 → **추가 정보 → 실행** |
| **macOS** (Apple Silicon) | `BirdPocket-1.1.3-arm64.dmg` | Applications로 드래그 → **시스템 설정 → 개인정보 보호 및 보안 → "그래도 열기"** |
